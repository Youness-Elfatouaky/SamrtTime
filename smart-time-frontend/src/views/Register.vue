...
<template>
  <main class="auth-page min-h-screen w-screen overflow-hidden relative bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50">
    ...
    <!-- Content container -->
    <div class="relative min-h-screen w-full flex items-center justify-center px-4">
      <div class="w-full max-w-xl">
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="mt-6 text-4xl font-extrabold text-gray-900">Create your account</h2>
          <p class="mt-3 text-lg text-gray-600">Join SmartTime and start managing your time effectively</p>
        </div>

        <!-- Register form card -->
        <div class="bg-white/80 backdrop-blur-lg shadow-2xl sm:rounded-2xl border border-gray-100">
